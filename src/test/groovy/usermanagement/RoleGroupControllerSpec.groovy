...
class RoleGroupControllerSpec extends Specification implements ControllerUnitTest<RoleGroupController>, DomainUnitTest<RoleGroup> {
    ...
    void "Test the save action correctly persists"() {
        ...
        request.json = new RoleGroup(params)
        controller.save()
    ...
    void "Test the save action with an invalid instance"() {
        ...
        controller.roleGroupService = Mock(RoleGroupService) {
            1 * save(_ as RoleGroup) >> { RoleGroup roleGroup ->
                throw new ValidationException("Invalid instance", roleGroup.errors)
            }
        }
    ...
    void "Test the update action correctly persists"() {
        ...
        request.method = 'PUT'
        populateValidParams(params)
        def instance = new RoleGroup(params)
        instance.id = 1
        instance.version = 0
